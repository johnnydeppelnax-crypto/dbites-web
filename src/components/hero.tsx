...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden min-h-[100svh] flex items-center">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] md:w-[800px] md:h-[800px] bg-gradient-to-br from-orange-200/40 to-amber-100/30 rounded-full blur-3xl -translate-y-1/3 translate-x-1/4 animate-liquid-wave" />
      <div className="absolute bottom-0 left-0 w-[300px] h-[300px] md:w-[600px] md:h-[600px] bg-gradient-to-tr from-cyan-200/30 to-teal-100/20 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4 animate-liquid-wave" />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ perspective: '1500px' }}>
        ...
        <motion.div style={{ y: y2 }} className="absolute -top-10 -left-10 md:-top-16 md:-left-16 animate-drift-slow">
          <div className="fruit-3d-prominent w-32 h-32 md:w-80 md:h-80 rounded-full overflow-hidden opacity-30 md:opacity-40 fruit-3d-shine">
            <img src="/products/3d-pineapple.png" alt="" className="w-full h-full object-contain p-4 md:p-6" />
          </div>
        </motion.div>

        <motion.div style={{ y: y2 }} className="absolute -bottom-10 -right-10 md:-bottom-16 md:-right-16 animate-drift-medium">
          <div className="fruit-3d-prominent w-36 h-36 md:w-96 md:h-96 rounded-full overflow-hidden opacity-25 md:opacity-35 fruit-3d-shine">
            <img src="/products/3d-orange.png" alt="" className="w-full h-full object-contain p-4 md:p-6" />
          </div>
        </motion.div>
        ...
        <motion.div style={{ y: y1 }} className="absolute top-[6%] left-[5%] animate-float3d-1">
          <div className="fruit-3d fruit-shadow w-24 h-24 md:w-48 md:h-48 rounded-full overflow-hidden opacity-40 md:opacity-60 fruit-3d-shine border-2 md:border-3 border-white/50 shadow-2xl">
            <img src="/products/3d-mango.png" alt="" className="w-full h-full object-contain p-2 md:p-3" />
          </div>
        </motion.div>
        ...
        <motion.div style={{ y: y3 }} className="absolute bottom-[20%] right-[5%] animate-float3d-1 hidden sm:block">
          <div className="fruit-3d fruit-shadow w-16 h-16 md:w-30 md:h-30 rounded-full overflow-hidden opacity-50 md:opacity-60 fruit-3d-shine border-2 border-white/50 shadow-xl">
      ...
      {/* Content */}
      <motion.div style={{ opacity }} className="relative container mx-auto px-4 sm:px-6 py-16 sm:py-24 md:py-36 z-10">
